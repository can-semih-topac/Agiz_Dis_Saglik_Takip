...
// AuthManager ve UserManager (profilden parola değiştirme) ortak kullanıyor.
internal static class AuthEmailTemplates
{
    ...
    public static string ResetCodeEmail(string fullName, string code) => $"""
        <html>
            <body style="font-family: Arial, sans-serif;">
                ...
                <p>Parola sıfırlama isteğinde bulundunuz. Doğrulama kodunuz:</p>
    ...
    public static string PasswordChangedEmail(string fullName) => $"""
        <html>
            <body style="font-family: Arial, sans-serif;">
                <h2>Merhaba, {fullName}</h2>
                <p>Hesabınızın parolası az önce değiştirildi.</p>

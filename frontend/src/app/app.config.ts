...
export const appConfig: ApplicationConfig = {
  providers: [
    ...
    // Angular'ın zone'u içindeki yakalanmamış hataları da Sentry'ye iletsin diye —
    // main.ts'teki Sentry.init() gibi sadece production'da devrede.
    ...(environment.production ? [{ provide: ErrorHandler, useValue: Sentry.createErrorHandler() }] : [])
  ]
};
